...
class MyHomePage extends StatelessWidget {
  MyHomePage({super.key}); // constructor sesuai instruksi

  final String nama = "Jonathan Yitskhaq Rundjan"; // nama
  final String npm = "2406435231"; // npm
...
class ItemHomepage {
  ...
  final String snackMessage;   // pesan snackbar
